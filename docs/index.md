...
1. **Read the Fundamentals** section to understand LLM basics
2. **Set up the Sandbox** environment for hands-on practice
3. **Follow the Day-by-Day curriculum** at your own pace
4. **Practice with real examples** from materials science
5. **Download the Cheat Sheet** for quick reference
...
**Ready to begin?** Start with [What are LLMs?](fundamentals/what-are-llms.md) →
